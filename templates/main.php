                ...
                <div class="lot__info">
                    ...
                    <div class="lot__state">
                        <div class="lot__rate">
                            ...
                            <span class="lot__cost"><?= price_format(htmlspecialchars($good['price'])); ?></span>
                        </div>
                        <?php $time_left_arr = count_time_left(htmlspecialchars($good['last_date'])); ?>
                        <div class="lot__timer timer <?php if ($time_left_arr[0] < 1) : ?> timer--finishing<?php endif;?>">
                            <?= "$time_left_arr[0]: $time_left_arr[1]"?>
                        </div>
                    </div>
                </div>
            </li>
